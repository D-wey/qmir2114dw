...
What is the average treatment effect of EU accession for Romania? Based on the two previous exercises you already have everything you need! Alternatively, you cna use the code below to calculate the differences between the two countries. Do not forget to round to two digits after the comma.
