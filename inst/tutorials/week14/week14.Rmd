...
In the next few tasks, you will go through the steps necessary to calculate the causal effect of EU membership on anti-authoritarian attitudes of the countries` citizens using a difference-in-differences design. In particular, you will calculate the causal effect of EU-accession on anti-authoritarian values for Romania (treatment unit) compared to Albania (control unit) assuming that anti-authoritarian attitudes would have developed similarly in both countries in the absence of Romania's EU accession.
...
What is the average treatment effect of EU accession for Romania? Based on the two previous exercises you already have everything you need! Alternatively, two items `difference_albania` and `difference_romania` have already been specified for you. Do not forget to round to two digits after the comma.

```{r set-up}

difference_albania <- df_learnr14$cntrymean_antiauth[df_learnr14$countryname == "Albania" & df_learnr14$wave == "2008-2010"] - df_learnr14$cntrymean_antiauth[df_learnr14$countryname == "Albania" & df_learnr14$wave == "1999-2004"]

difference_romania <- df_learnr14$cntrymean_antiauth[df_learnr14$countryname == "Romania" & df_learnr14$wave == "2008-2010"] - df_learnr14$cntrymean_antiauth[df_learnr14$countryname == "Romania" & df_learnr14$wave == "1999-2004"]
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(default_ui(url ="https://ilias.uni-mannheim.de/ilias.php?baseClass=ilObjSurveyGUI&ref_id=1114228&cmd=infoScreen"))
```